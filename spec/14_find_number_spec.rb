...
describe FindNumber do
  ...
  describe '#game_over?' do
    ...
    context 'when guess and random_number are equal' do
      ...
      subject(:game_correct_guess) { described_class.new(0, 9, random_number, 8) }
      ...
      it 'is game over' do
        expect(game_correct_guess).to be_game_over
      end
    end
    ...
    context 'when guess and random_number are not equal' do
      subject(:game_incorrect_guess) { described_class.new(0, 9, random_number, 7) }
      it 'is not game over' do
        expect(game_incorrect_guess).not_to be_game_over
      end
    end
  end
